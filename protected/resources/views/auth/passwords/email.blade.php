...
<body class="hold-transition email-page">
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form class="form-horizontal" method="POST" action="{{ route('password.email') }}">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-info btn-block btn-flat margin-top-10" style="font-size:15px">SEND PASSWORD RESET LINK</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
        ...
        <div class="margin-top-30 text-center">
            <p>Remember your password? <a href="{{URL::to("/login")}}" class="text-info m-l-5">Sign In</a></p>
        </div>
