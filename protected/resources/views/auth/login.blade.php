    ...
    <div class="login-box-body">
        ...
        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-info btn-block btn-flat margin-top-10" style="font-size:15px">SIGN IN</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
        ...
        <div class="margin-top-30 text-center">
            {{--<p>Don't have an account? <a href="{{URL::to("/register")}}" class="text-info m-l-5">Sign Up</a></p>--}}
        </div>
