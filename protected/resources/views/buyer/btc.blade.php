...
@section('content-header')
    <section class="content-header">
        <h1>
            Tokenomy
            <small>List Buyers BTC</small>
        </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fa fa-users"></i>List Buyers BTC</a></li>
        </ol>
    </section>
@endsection
        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">List Buyers BTC</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <p class="col-md-4" style="float: left">Payment Address(btc)</p>
                                                <p class="col-md-8" style="float: left">: {{ $buyer['payment_address'] }}</p>
                                            </div>
                                            <div class="row">
                                                <p class="col-md-4" style="float: left">Refund Address(btc)</p>
